...
//region Lifecycls Methods
    ...
    public void onContactMePreferenceClicked() {
        ...
        try {
            ...
            InteractionUtility.showSnackbar(((SettingsFragment) getView()).getRoot(), mApplicationContext.getString(R.string.pref_contact_developer_error_message), Snackbar.LENGTH_LONG);
        }
    }
